window.PAGE_CONTENT = {
  ...
  vehicles: [
    {
      title: "Gas Vehicles",
      description: "2000 and newer Sedans, SUVs, and light-duty gas trucks.",
    },
    {
  ...
  customerInfo: [
    {
      title: "What To Bring",
      text: "Your vehicle registration paperwork, vehicle keys, and a valid photo ID.",
      url: "https://www.bar.ca.gov/smog-check",
      label: "California Bureau of Automotive Repair smog check guide",
    },
    {
